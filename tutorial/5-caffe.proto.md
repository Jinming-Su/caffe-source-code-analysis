### Caffe.proto
This file is compiled before caffe.cpp and generates many functions for furtuher usage of Caffe.  
...
SolverParameter
LayerParameter
// Next is definitation of each layer_parameter
```


### Comments for souce code
```
syntax = "proto2"; // version of protobuf
...
message BlobShape {
  // The size of blob is Num * Channel * Height * Width
  // The high-dimensional data in Caffe is based on multi-dimensional nesting of contains i.e. Vector.
...
// around.
// A Vector to store several blobproto
...
// Types of filler include constant, gaussian, positive_unitball(sum of all weights in input is 1), 
// uniform, xavier, msar, bilinear
...
### Reference
* https://blog.csdn.net/weixin_39970417/article/details/80825601
